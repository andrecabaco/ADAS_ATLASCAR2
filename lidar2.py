...
def main():
    ...
    # Init the subscriber
    subscriber_left = rospy.Subscriber('/left_laser/scan', LaserScan, partial(msgReceivedCallback, publisher=publisher))
    subscriber_right = rospy.Subscriber('/right_laser/scan', LaserScan, partial(msgReceivedCallback, publisher=publisher))
